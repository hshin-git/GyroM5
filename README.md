...
- (2021/7/4更新) 新型のv2スケッチ[GyroM5v2.ino](GyroM5v2/GyroM5v2.ino)は、スマートフォン連携、可変サーボ周波数等に対応です。
...
新型のv2スケッチは、設定作業にスマホが必要となりますが、v1スケッチの上位互換となる以下の機能を備えています。
つまりv2スケッチは、RCカーの性能をv1スケッチより引き出して、RCカーを楽しくするファームウェアであり、スマホユーザにお勧めです。
