...
プログラム"GyroPID.ino"をArduinoIDEでコンパイル＆転送してRC受信機及びサーボと接続するだけで、M5StickC単体でRCカー用ジャイロとして機能します。
...
自分は、コロナ禍で屋内遊びをさがす中、小学生以来めっちゃ久しぶりにタミヤ製RCカーキット（小型のSU-01シャーシ）を購入してみました。
...
「元気っ子さん」は、GyroPID搭載RCカーの試験走行、ヨコモYD-2レンタカーの体験走行などで、お世話になっています。
